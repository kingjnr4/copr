...
Android application development. This package contains Google's beta channel
x86_64 Linux distribution and its bundled JetBrains Runtime.

It can be installed alongside the stable and canary channel packages.
